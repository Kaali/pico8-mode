* PICO-8 mode
  ...
  *pico8-mode* is a major mode for Emacs which supports PICO-8 .p8 file
...
** Notes
   ...
   This mode uses some internal functiosn from [[https://github.com/immerrr/lua-mode][lua-mode]], which means
